...
SELECT ID_RANK, Country, Healthy_life_expectancy as min_Health_Life_Exp
FROM data2022
group by Country,ID_RANK,Healthy_life_expectancy
...
FROM data2022
group by Country,Healthy_life_expectancy
...
FROM data2022
Group by ID_RANK,Country,freedom_to_choose
Order by freedom_to_choose desc
Limit 5;

-- Top 5 countries in Generosity
SELECT ID_RANK, Country, Generosity
FROM data2022
